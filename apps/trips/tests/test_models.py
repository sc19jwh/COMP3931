...
class CityModelTest(TestCase):
    ...
    def test_creation(self):
        ...
        self.assertEqual(self.city.food_budget, self.food_budget)
        self.assertEqual(self.city.accom_budget, self.accom_budget)
...
class TripModelTest(TestCase):
    def setUp(self):
        ...
        self.trip = Trip.objects.create(user = self.user, title = self.title, start_date = self.start_date,
                                        journey_times = self.journey_times, food_budget = self.food_budget,
                                        climate = self.climate, accom_budget = self.accom_budget)
    ...
    def test_creation(self):
        ...
        self.assertEqual(self.trip.food_budget, self.food_budget)
        self.assertEqual(self.trip.accom_budget, self.accom_budget)
