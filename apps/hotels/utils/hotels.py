...
# INPUT: currency, id of place, date of checkin and checkout
# OUTPUT: list of hotels and session token for further search
# e.g. quick_hotel_search("GBP", 1234, 2023, 9, 10, 2023, 9, 15):
...
# INPUT: session_token obtained from quick_hotel_search() and page number to retrieve
# OUTPUT: list of hotels
# e.g. full_hotel_search(session_token, 3)
